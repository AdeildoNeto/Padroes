<%-- 
    ...
    Created on : 30/06/2017, 20:42:38
    Author     : carlo
--%>
...
<html lang="pt-br">
    ...
    _________________________________________________________ -->
        ...
        <div id="content">
            <div class="container">
                <p class="text-muted lead text-center">Estabelecimentos próximos ao seu endereço</p>

                <div class="row products">

                    <c:forEach var="estabelecimento" items="${lista_estab}">
