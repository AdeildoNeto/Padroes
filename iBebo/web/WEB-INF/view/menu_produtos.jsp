<%-- 
    Document   : menu_produtos
    Created on : 30/06/2017, 22:46:59
    Author     : carlo
--%>
    ...
    _________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>${sessionScope.usuarioLogado.nome}</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row products">
                            ...
                            <c:forEach var="produto" items="${lista_prod}">
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="Menu?acao=detalhe_produto&id=${produto.idProduto}">${produto.nomeProduto}</a></h3>
                                        <p class="price">R$ ${produto.precoProduto}</p>
                                    </div>
                                    <!-- /.text -->
                                </div>
                                <!-- /.product -->
