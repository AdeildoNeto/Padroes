            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 clearfix" id="checkout">
                        ...
                        <div class="box">
                            <form method="post" action="SalvarCompra">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="shop-checkout1.html"><i class="fa fa-map-marker"></i><br>Endereço</a>
                                    </li> 
                                    <li><a href="shop-checkout3.html"><i class="fa fa-money"></i><br>Pagamento</a>
                                    </li>
                                    <li class="active"><a href="#"><i class="fa fa-eye"></i><br>Confirmar compra</a>
                                    </li>
                                </ul>
                                ...
                                <div class="content">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach var="produto" items="${prod_carrinho_confirmar}">
                                                <tr>
                                                    <td>
                                                        <a href="#">
