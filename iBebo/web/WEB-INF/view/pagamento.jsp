                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 clearfix" id="checkout">
                            ...
                            <div class="box">
                                <form method="post" action="ConfirmarPagamento">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><a href="shop-checkout1.html"><i class="fa fa-map-marker"></i><br>Endereço</a>
                                        </li>

                                        <li class="active"><a href="#"><i class="fa fa-money"></i><br>Pagamento</a>
                                        </li>
                                        <li class="disabled"><a href="shop-checkout4.html"><i class="fa fa-eye"></i><br>Confirmar Compra</a>
                                        </li>
                                    </ul>
                                            ...
                                            <c:forEach var="cartao" items="${listaCartao}">
                                                <div class="col-sm-6">
                                                    <div class="box payment-method">
                                                        ...
                                                        <h4>Número do Cartão: ${cartao.numeroCartaoCredito}</h4>
                                                        <p>Data de validade: ${cartao.dataValidadeCartaoCredito}</p>
